...
import dao.VendaExclusaoPostgresDAO;
...
import org.example.dao.jpa.impl.postgres.ClientePostgresDAO;
import org.example.dao.jpa.impl.postgres.ProdutoPostgresDAO;
import org.example.dao.jpa.impl.postgres.VendaJpaDAO;
...
public class VendaPostgresDAOTest {
    ...
    public VendaPostgresDAOTest() {
        this.vendaDao = new VendaJpaDAO();
        vendaExclusaoDao = new VendaExclusaoPostgresDAO();
        this.clienteDao = new ClientePostgresDAO();
